...
async def play(_, message: Message):
    ...
    lel = await message.reply("**⭐ MAMAKLİBOT ⭐**:DİNLE DİNLE ÇALIYOR...")
    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**⭐ MAMAKLİBOT ⭐**❌ Video uzun geldi {DURATION_LIMIT} minute(s) bilmiyosan oynama!🙄"
            )
        ...
        await lel.edit("**⭐ MAMAKLİBOT ⭐**: 🔎ariyom ya la...")
        sender_id = message.from_user.id
        ...
        for i in message.command[1:]:
            query += ' ' + str(i)
        print(query)
        await lel.edit("**⭐ MAMAKLİBOT ⭐**: AMACIMIZ NEŞE YAPIŞTIR KEŞE... ")
        ...
        try:
            ...
            lel.edit(
                "**⭐ MAMAKLİBOT ⭐**: ❌ GARDAŞ YANLİSİN VAR.\n\nBİRAK SİMDİ BOZACAN."
            )
            print(str(e))
            return
